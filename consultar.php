...
$stmt = $db->prepare('SELECT asignatura, grupo, profesor, turno, semestre, estatus FROM inscripcion WHERE matricula = ?');
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light display-6" style="background-color: #FFFFFF;">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active navbar-brand" href="./panel_usuario.php">Inicio<span class="sr-only">(current)</span></a>
                    <a href="./preinscribir.php" class="nav-item nav-link active navbar-brand">Preinscribir Asignatura</a>
                    <a href="./consultar.php" class="nav-item nav-link active navbar-brand">Consultar Inscripcion</a>
    ...
    <main>
        ...
        if (count($asignaturas) > 0) {
            ...
            echo '<tr><th>Asignatura</th><th>Grupo</th><th>Profesor</th><th>Turno</th><th>Semestre</th><th>Estatus</th></tr>';
            ...
            echo 'No tienes asignaturas registradas.';
        }
